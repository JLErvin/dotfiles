...
highlight CursorLineNr term=bold ctermfg=Grey guifg=Grey
highlight CursorLineNr term=bold ctermbg=darkgrey guifg=White

set fillchars+=vert:\ 
set guifont=GohuFont\ Powerline:h10
set nowrap
set number
set relativenumber
